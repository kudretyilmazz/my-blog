	...
	return (
		<footer className="flex flex-col mt-auto">
			{/* <div className="flex gap-x-5 justify-center items-center">
				<a href="https://www.instagram.com/kudretylmzzzx/" target="_blank" rel="noreferrer">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						className="h-8 w-8 dark:fill-white cursor-pointer"
						viewBox="0 0 448 512"
					>
				...
				<a href="https://twitter.com/kudretylmzzz" target="_blank" rel="noreferrer">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						className="h-8 w-8 dark:fill-white cursor-pointer"
						viewBox="0 0 448 512"
