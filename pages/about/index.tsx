...
const Index = () => {
	...
	return (
		<Layout title={t("ABOUT_TITLE")} description="Hakkımda ve iletişim bilgilerim">
					...
					<div className="bio">
						<div className="flex justify-between items-center">
							...
							<button
								...
								className="hidden md:block px-6 py-3 bg-secondary text-white font-regular rounded-full duration-500 transition hover:scale-105 "
							>
						...
						<div id="contact-adress" className="mt-3">
							<div className="flex items-center gap-x-2">
								<svg
									...
									xmlSpace="preserve"
									className="w-5 h-5  dark:fill-white cursor-pointer"
								>
									<g>
								...
								<a aria-label="my email" href="mailto:kudretylmzzz@gmail.com">
									kudretylmzzz@gmail.com
								</a>
							</div>
							<div className="flex items-center gap-x-2">
								<svg
